...
public class Queen extends Piece{
    ...
    private final static int[] CANDIDATE_MOVE_VECTOR_COORDINATES = {-1, -7, -8, -9, 1, 7, 8, 9};
            ...
            while(BoardUtils.isValidTileCoordinate(candidateDestinationCoordinate)){
                ...
                if(BoardUtils.isValidTileCoordinate(candidateDestinationCoordinate)){
                    ...
                    if(!candidateDestinationTile.isTileOccuped()){
                        legalMoves.add(new Move.MajorMove(board, this, candidateDestinationCoordinate)); // this = the current queen
                        ...
                        break; /**This break is used for indicate that after any piece(enemy or not) the Queen cannot move */
                    }
                }
